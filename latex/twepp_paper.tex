...
% TODO: fix command so that there is always space after text
\newcommand{\vtrx}{VTRx+}
...
The new inner tracker (the pixel detector) will have about two billion silicon pixels installed.
...
The lpGBTs convert optical signals to electrical signals (and vise versa), and the \vtrx modules establish optical links with the DTCs.
