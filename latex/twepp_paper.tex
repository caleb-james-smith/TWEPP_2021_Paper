...
The portcards play an important role in the readout chain in converting electrical signals from on detector ROCs to optical signals for off detector DTCs.
...
% over commercial DP cable, adapter and Molex FPC cables.
