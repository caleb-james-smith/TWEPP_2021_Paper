...
The port-cards are printed circuit boards that each carry three Low-Power Gigabit Transceivers (lpGBT) and three Versatile Link PLUS Transceivers (\vtrxp) modules~\cite{ref:lpgbt,ref:vtrxp}.
...
\caption{
\label{fig:readout}
System readout architecture for the inner tracker.
}
\end{figure}
