...
The portcards each carry three Low-Power Gigabit Transceivers (lpGBT) and three Versatile Link PLUS Transceivers (\vtrxp) modules~\cite{ref:lpgbt,ref:vtrxp}.
...
The electrical links (e-links) are created using low mass, small diameter twisted pairs.
One end of a twisted pair electrical link is shown in figure~\ref{fig:elink}.
...
The RD53 chip on a Single Chip Card (SCC) is read out over e-links using an FC7~\cite{ref:fc7}.
