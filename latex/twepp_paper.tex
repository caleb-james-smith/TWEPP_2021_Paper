...
Scan of bit-error rate vs. clock sampling phase and equalization setting for electrical link receivers on the lpGBT driven by the RD53 pixel readout chip.
