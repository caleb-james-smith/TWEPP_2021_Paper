...
The amplitude of the PRBS signal is varied using the ``TAP0'' pre-emphasis DAC setting, which ranges from 0 to 1000 and controls the signal amplitude output by the current mode logic (CML) driver on the RD53 chip.
